...
Page({
    ...
    async loadAITools() {
        try {
            ...
            const params = (0, parameter_1.generateRequestParams)(token, '', apiPath);
    ...
    async getAuthHeaders() {
        ...
        const params = (0, parameter_1.generateRequestParams)(token, requestBody, apiPath);
