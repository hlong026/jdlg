...
Page({
    ...
    async onGenerateDesign() {
        ...
        try {
            ...
            // 生成请求参数
            const params = (0, parameter_1.generateRequestParams)(token, designData, apiPath, deviceID);
